...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        "group/input-group border-input dark:bg-input/30 shadow-2xs relative flex w-full items-center corner-squircle rounded-[100px] border outline-hidden transition-[color,box-shadow]",
