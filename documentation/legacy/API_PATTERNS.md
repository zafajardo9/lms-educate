...
> **⚠️ MIGRATION NOTE**: This project has been migrated from MongoDB/Mongoose to PostgreSQL/Prisma.  
> For complete Prisma patterns and examples, see **[API_PATTERNS_PRISMA.md](./API_PATTERNS_PRISMA.md)**.  
...
export async function GET(request: NextRequest) {
  try {
    ...
    // 4. Build Prisma where clause with role-based filtering
    let where: any = {};
